...
from transformers.modeling_bert import BERT_PRETRAINED_MODEL_ARCHIVE_LIST, load_tf_weights_in_bert, BertEmbeddings, \
    BertLayer, BertPooler, BertOnlyMLMHead, BertOnlyNSPHead, BertPreTrainingHeads
...
class BertModelThesues(BertPreTrainedModel):
    def __init__(self, config, fine_tune_scc=False, scc_layer=6):
        ...
        self.encoder = BertEncoder(config, fine_tune_scc=fine_tune_scc, scc_n_layer=scc_layer)
...
class BertForPreTraining(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = BertModelThesues(config)
